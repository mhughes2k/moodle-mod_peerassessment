...
if ($groupid) {
    switch ($peerassessment->frequency) {
        ...
        case PA_FREQ_WEEKLY:
            ...
            $a[] = get_string('averageratingreceived', 'peerassessment');
            $b[] = get_string('averageratinggiven', 'peerassessment');
            ...
            $table = peerassessment_get_table_weekly_frequency($peerassessment, $group);
            print_heading(get_string('details', 'peerassessment'));
            break;
        case PA_FREQ_UNLIMITED:
            $table = peerassessment_get_table_unlimited_frequency($peerassessment, $group);
            break;
            break;
    }
