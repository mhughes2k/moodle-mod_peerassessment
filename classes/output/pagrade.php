...
class pagrade /* MoodleQuickForm_pagrade */ extends \MoodleQuickForm_group{
    ...
    public function _createElements() {
        ...
        $scaleselect = @\MoodleQuickForm::createElement('select', 'pagrade_scale', $langscale, $scales, $attributes);
        ...
        $maxgrade = @\MoodleQuickForm::createElement('text', 'pagrade_point', $langmaxgrade, array());
        ...
        $typeselect = @\MoodleQuickForm::createElement('select', 'pagrade_type', $langtype, $gradetype, $attributes, true);
